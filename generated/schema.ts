...
export class DctdaoFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save DctdaoFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save DctdaoFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("DctdaoFactory", id.toString(), this);
  }

  static load(id: string): DctdaoFactory | null {
    return store.get("DctdaoFactory", id) as DctdaoFactory | null;
  }
  ...
  get totalVolumeDCTD(): BigDecimal {
    let value = this.get("totalVolumeDCTD");
    return value.toBigDecimal();
  }

  set totalVolumeDCTD(value: BigDecimal) {
    this.set("totalVolumeDCTD", Value.fromBigDecimal(value));
  }
  ...
  get totalLiquidityDCTD(): BigDecimal {
    let value = this.get("totalLiquidityDCTD");
    return value.toBigDecimal();
  }

  set totalLiquidityDCTD(value: BigDecimal) {
    this.set("totalLiquidityDCTD", Value.fromBigDecimal(value));
  }
...
export class Token extends Entity {
  ...
  get derivedDCTD(): BigDecimal | null {
    let value = this.get("derivedDCTD");
  ...
  set derivedDCTD(value: BigDecimal | null) {
    if (value === null) {
      this.unset("derivedDCTD");
    } else {
      this.set("derivedDCTD", Value.fromBigDecimal(value as BigDecimal));
    }
  }
...
export class Pair extends Entity {
  ...
  get reserveDCTD(): BigDecimal {
    let value = this.get("reserveDCTD");
    return value.toBigDecimal();
  }

  set reserveDCTD(value: BigDecimal) {
    this.set("reserveDCTD", Value.fromBigDecimal(value));
  }
  ...
  get trackedReserveDCTD(): BigDecimal {
    let value = this.get("trackedReserveDCTD");
    return value.toBigDecimal();
  }

  set trackedReserveDCTD(value: BigDecimal) {
    this.set("trackedReserveDCTD", Value.fromBigDecimal(value));
  }
...
export class Bundle extends Entity {
  ...
  get dctdPrice(): BigDecimal {
    let value = this.get("dctdPrice");
    return value.toBigDecimal();
  }

  set dctdPrice(value: BigDecimal) {
    this.set("dctdPrice", Value.fromBigDecimal(value));
  }
}

export class DctdaoDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save DctdaoDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save DctdaoDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("DctdaoDayData", id.toString(), this);
  }

  static load(id: string): DctdaoDayData | null {
    return store.get("DctdaoDayData", id) as DctdaoDayData | null;
  }
  ...
  get dailyVolumeDCTD(): BigDecimal {
    let value = this.get("dailyVolumeDCTD");
    return value.toBigDecimal();
  }

  set dailyVolumeDCTD(value: BigDecimal) {
    this.set("dailyVolumeDCTD", Value.fromBigDecimal(value));
  }
